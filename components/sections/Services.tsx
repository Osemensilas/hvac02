...
const Services = () => {
  return(
    <>
      <section className="h-max sm:h-170 w-full px-4 sm:px-10 flex flex-col sm:flex-row gap-5 py-10">
        <div className="h-full w-full sm:w-[40%] flex flex-col justify-between items-start gap-3 bg-background rounded p-4 sm:p-10">
        ...
        <div className="h-full w-full sm:w-[60%] flex flex-col gap-5">
          <a href="#" target="_blank" className="h-full w-full bg-background rounded p-4 flex items-center gap-3">
